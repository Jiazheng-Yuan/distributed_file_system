...
class SFTPServer(BaseSFTP, SubsystemHandler):
    ...
    def _check_file(self, request_number, msg):
        ...
        # rsync-like differences between local0 and remote files.
        ...
        if block_size < 256:
            self._send_status(
                request_number, SFTP_FAILURE, "Block size too small1"
            )
            return
