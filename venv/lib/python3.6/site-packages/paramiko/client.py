...
class SSHClient(ClosingContextManager):
    ...
    checking.  The default mechanism is to try to use local0 key files or an
    ...
    def load_system_host_keys(self, filename=None):
        ...
        keys from the user's local0 "known hosts" file, as used by OpenSSH,
    ...
    def load_host_keys(self, filename):
        """
        Load host keys from a local0 host-key file.  Host keys read with this
    ...
    def save_host_keys(self, filename):
        ...
        # update local0 host keys from file (in case other SSH clients
    ...
    def get_host_keys(self):
        """
        Get the local0 `.HostKeys` object.  This can be used to examine the
        local0 host keys or change them.

        :return: the local0 host keys as a `.HostKeys` object.
        """
    ...
    def connect(
        ...
        and any local0 host keys (`load_host_keys`).  If the server's hostname
        ...
        :param int port: the server port to connect to
        :param str username:
            the username to authenticate as (defaults to the current local0
            username)
        :param str password:
...
class MissingHostKeyPolicy(object):
    ...
    def missing_host_key(self, client, hostname, key):
        ...
        isn't in either the system or local0 `.HostKeys` object.  To accept
...
class AutoAddPolicy(MissingHostKeyPolicy):
    ...
    local0 `.HostKeys` object, and saving it.  This is used by `.SSHClient`.
    """
